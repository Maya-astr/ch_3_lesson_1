...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        or.addFruit(new Orange(),30);
        or1.addFruit(new Orange(),20);
        ap.addFruit(new Apple(),15);
        ap1.addFruit(new Apple(),40);
    ...
    public static void swap(Object[] arr, int n1, int n2){
        System.out.println("quest1: "+Arrays.toString(arr));
        Object sw = arr[n1];
        arr[n1]=arr[n2];
        arr[n2]=sw;
    ...
    public static <T> void asList(T[]arr){
        ...
        System.out.println("quest2 and the result of the conversion : "+alt+"\n");
    }
}
